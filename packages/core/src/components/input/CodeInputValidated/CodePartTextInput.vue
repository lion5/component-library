...
import { allowedCodeCharacters } from '@core/components/input/CodeInputValidated/codeInputValidation'
import type { FieldMeta } from 'vee-validate'
import BaseInputWrapper from '@core/components/input/BaseInputWrapper/BaseInputWrapper.vue'
