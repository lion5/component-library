...
export const DefaultWithDifferentAspectRatios: Story = {
  ...
  args: {
    images: [
      ...
      new MinimalImage(4, 'alt', 'https://dummyimage.com/2000x500/880000/fff.png'),
      new MinimalImage(5, 'alt', 'https://dummyimage.com/2000x1000/770000/fff.png'),
      new MinimalImage(6, 'alt', 'https://dummyimage.com/2000x1000/660000/fff.png'),
      new MinimalImage(7, 'alt', 'https://dummyimage.com/2000x1000/550000/fff.png'),
      new MinimalImage(8, 'alt', 'https://dummyimage.com/2000x1000/440000/fff.png'),
      new MinimalImage(9, 'alt', 'https://dummyimage.com/2000x1000/330000/fff.png'),
      new MinimalImage(10, 'alt', 'https://dummyimage.com/2000x1000/220000/fff.png')
    ]
  }
}
