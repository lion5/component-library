...
import { DEFAULT_MISSION_LOCATION } from '@/stores/missions'
...
const center = computed(
  () => props.modelValue?.toLatLng() || DEFAULT_MISSION_LOCATION.toLatLng()
)
defineExpose({ marker })
...
const {
  ...
  initialValue: props.modelValue || DEFAULT_MISSION_LOCATION,
})
